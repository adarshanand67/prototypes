...
app.post('/api/users', async (req: Request<{}, {}, UserBody>, res: Response) => {
...
app.post('/api/shards/posts', async (req: Request<{}, {}, PostBody>, res: Response) => {
...
app.get('/api/shards/posts/:user_id', async (req: Request<{ user_id: string }>, res: Response) => {
